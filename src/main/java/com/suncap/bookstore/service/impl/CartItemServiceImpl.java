...
import com.suncap.bookstore.repository.BookToCartItemRepository;
import com.suncap.bookstore.repository.CartItemRepository;
...
public class CartItemServiceImpl implements CartItemService{
	...
	public CartItem addBookToCartItem(Book book, User user, int qty) {
		...
		BookToItemCart bookToCartItem = new BookToItemCart();
